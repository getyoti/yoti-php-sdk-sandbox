...
<body class="yoti-body">
    <main>
        <section class="yoti-top-section">
            ...
            <h1 class="yoti-top-header"><?php echo e($title); ?></h1>
    ...
    <script>
        window.Yoti.Share.init(<?php echo json_encode($buttonConfig, JSON_PRETTY_PRINT, 512) ?>);
    </script>
</body>

</html><?php /**PATH /usr/share/nginx/html/resources/views/share.blade.php ENDPATH**/ ?>